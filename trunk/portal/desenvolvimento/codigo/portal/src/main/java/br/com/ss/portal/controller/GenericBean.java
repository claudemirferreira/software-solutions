...
import br.com.ss.portal.exception.ValidationException;
import br.com.ss.portal.model.entity.AbstractEntity;
import br.com.ss.portal.service.IService;
import br.com.ss.portal.util.Relatorio;
...
public abstract class GenericBean<T extends AbstractEntity> implements
	...
	protected void setup() throws InstantiationException,
		...
		initEntity();
		init();
		relatorio.setPath(entity.getClass().getSimpleName().toLowerCase());
	...
	public void print() {
		...
		try {
			...
			JasperPrint preencher = JasperFillManager.fillReport(
					relatorio.getPath(), relatorio.getParametros(),
