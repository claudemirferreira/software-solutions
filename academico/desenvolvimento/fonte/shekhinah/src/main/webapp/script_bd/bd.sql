...
INSERT INTO `acad_aluno` (`id_aluno`,`bairro`,`celular`,`cep`,`cpf`,`data_cadastro`,`data_nascimento`,`email`,`endereco`,`fone_comercial`,`fone_residencial`,`nome`,`rg`,`sexo`,`grau_parentesco`) VALUES 
 (1,'YYY','43243242','434343','7878777','2014-02-26 14:54:30',NULL,'EEWEWE','WWWW',NULL,'RWQERWQR','CLAUDEMIR RAMOS FERREIRA','6666','M','');
...
INSERT INTO `saa_rotina` (`id_rotina`,`acao`,`imagem`,`nome`,`status`,`id_sistema`) VALUES 
 ...
 (5,'matriculaControlador.init','resources/imagens/rotina/coins.png','MATRICULA',0,2),
 (6,'rotinaControlador.init','resources/imagens/rotina/credit_card.png','ROTINAS',0,2),
 (7,'perfilControlador.init','resources/imagens/rotina/gold_bullion.png','PERFIL',0,2),
 (8,'usuarioControlador.init','resources/imagens/rotina/gold_bullion.png','USUARIO',0,2),
