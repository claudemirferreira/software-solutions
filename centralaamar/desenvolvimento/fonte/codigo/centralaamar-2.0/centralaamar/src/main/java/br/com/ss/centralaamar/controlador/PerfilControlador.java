...
import br.com.ss.centralaamar.model.servico.PerfilServico;
import br.com.ss.centralaamar.model.servico.RotinaServico;
import br.com.ss.centralaamar.model.servico.SimpleRegistrationService;
...
public class PerfilControlador implements Serializable {
	...
	public void enviar(){
		...
		simpleRegistrationService.register(user);
	}
	...
	public SimpleRegistrationService getSimpleRegistrationService() {
		return simpleRegistrationService;
	}

	public void setSimpleRegistrationService(
			SimpleRegistrationService simpleRegistrationService) {
		this.simpleRegistrationService = simpleRegistrationService;
	}
